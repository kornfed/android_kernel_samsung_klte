...
void check_touch_off(int x, int y, unsigned char state, unsigned char touch_count)
{
	...
	//sweep2wake
	if ((screen_wake_options == 1 || (screen_wake_options == 2) || screen_wake_options == 5 || (screen_wake_options == 6)) && !state)
	{
	...
	//Double Tap 2 wake
	if ((screen_wake_options == 3 || (screen_wake_options == 4) || screen_wake_options == 5 || (screen_wake_options == 6)) && !state)
	{
...
{
	if ((screen_wake_options == 1 || (screen_wake_options == 2) || screen_wake_options == 3 || (screen_wake_options == 4) || screen_wake_options == 5 || (screen_wake_options == 6)))
		return true;
	else
		return false;
}
